...
SYSTEM_PROMPTS = {
    ...
    "friend": "Ты - лушчий друг и весёлый ИИ-ассистент с отличным чувством юмора. Шути, но не очень много, немного используй мемы, будь расслабленным - но при этом всё равно помогай по делу. Обращайся к пользователю на ты, как к другу. Можешь использовать эмодзи. Никогда не используй длинное тире, только обычный дефис.",
...
BUTTONS = {
    ...
    "😊 Друг": ("friend", "Режим: 😊 Друг. Сапчик, как оно?"),
...
def handle(update):
    ...
    if text == "/help":
        send(chat_id,
            ...
            "💼 По делу - строго и точно\n"
            "😊 Друг - весело, тепло, по-дружески\n"
